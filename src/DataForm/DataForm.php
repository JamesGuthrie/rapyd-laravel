...
class DataForm extends Widget
{
    ...
    protected function buildFields()
    {
        ...
        // Once all fields have been correctly initialised, structure according to parent/child
        // relations. This ensures that the parent must not be responsible for initialising its
        // children as well.
